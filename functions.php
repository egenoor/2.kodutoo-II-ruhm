<?php
	...
	function signUp ($email, $password, $website, $comment, $age, $gender)	{
		
		$database = "if16_ege";
		$mysqli = new mysqli($GLOBALS["serverHost"], $GLOBALS["serverUsername"], $GLOBALS["serverPassword"], $database);
	
		//sqli rida
		$stmt = $mysqli->prepare("INSERT INTO user_sample (email, password, website, comment, age, gender) VALUES (?, ?, ?, ?, ?, ?)");
		
		echo $mysqli->error;
		
		$stmt->bind_param("ssssss", $email, $password, $website, $comment, $age, $gender);
